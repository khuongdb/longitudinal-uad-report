\section{Proposed Frameworks for Spatial-Temporal UAD}
\label{sec:method}
...
\subsubsection{Feature Attention Module}
...
\subsection{Temporal Diffusion Model for follow up data generation}
\label{sec:TDM}
